    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Diseases report</h4>
                  ...
                  <div id="report">
                    ...
                    <a href="<?= url('DiseasesPDFGeneration?diseases=' . urlencode(json_encode($diseases)) . '&start=' . $start . '&end=' . $end) ?>">
