                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href={{"diseaseDetails/"}}><i class="fa fa-eye" aria-hidden="true"></i>&nbsp; {{__('msg.view')}}</a>
                          <a class="dropdown-item" href={{"deletedisease/"}}><i class="fa fa-trash" aria-hidden="true"></i>&nbsp; {{ __('msg.delete')}}</a>
                      </div>
                          </td>
                         </tr>
